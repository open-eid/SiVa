...
public class ContentDispositionInteceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(
        ...
        if (handler instanceof HandlerMethod handlerMethod) {
            WithContentDisposition annotation = handlerMethod.getMethodAnnotation(WithContentDisposition.class);

            if (annotation != null) {
                request.setAttribute(CONTENT_DISPOSITION_FILENAME_ATTR, annotation.filename());
            }
        }
        return true;
    }
