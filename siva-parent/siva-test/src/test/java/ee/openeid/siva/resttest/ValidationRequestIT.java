...
public class ValidationRequestIT extends SiVaRestTests {
    ...
    public void validationRequestUnusualChars() {
        ...
        post(validationRequestWithValidKeys(encodedString, "ÕValid_IDCard_MobID_signatures.bdocÄÖÜ", ""))
                .then()
                .body("validationReport.validationConclusion.validatedDocument.filename", equalTo("ÕValid_IDCard_MobID_signatures.bdocÄÖÜ"));
    }
     ...
     * Requirement: http://open-eid.github.io/SiVa/siva/v2/interfaces/#validation-request-interface
     *
     * Title: Request with not supported documentType
     *
     * Expected Result: Error is returned
     *
     ...
     */
    @Test
    public void validationRequestNotSupportedDocumentType() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("PdfValidSingleSignature.pdf"));
        post(validationRequestWithDocumentTypeValidKeys(encodedString, "PdfValidSingleSignature.pdf", "BDOC",""))
                .then()
    ...
    public void bdocValidationRequestNotMatchingDocumentTypeAndActualFileDdoc() {
        ...
        post(validationRequestWithValidKeys(encodedString, "igasugust1.3.bdoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void bdocValidationRequestWrongSignaturePolicy() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("Valid_IDCard_MobID_signatures.bdoc"));
        post(validationRequestWithValidKeys(encodedString, "Valid_IDCard_MobID_signatures.bdoc", INVALID_SIGNATURE_POLICY))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
     ...
     * Requirement: http://open-eid.github.io/SiVa/siva/v2/interfaces/#validation-request-interface
     *
     * Title: Verification of case insensitivity in file extension
     *
    ...
    public void bdocValidationRequestNotMatchingDocumentTypeAndActualFileXroadBatch() {
        ...
        post(validationRequestWithValidKeys(encodedString, "xroad-batchsignature.bdoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void bdocValidationRequestNotMatchingDocumentTypeAndActualFileXroadAttach() {
        ...
        post(validationRequestWithValidKeys(encodedString, "xroad-attachment.bdoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void pdfValidationRequestWrongSignaturePolicy() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("PdfValidSingleSignature.pdf"));
        post(validationRequestWithValidKeys(encodedString, "PdfValidSingleSignature.pdf", INVALID_SIGNATURE_POLICY))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(SIGNATURE_POLICY))
                .body("requestErrors[0].message", Matchers.containsString("Invalid signature policy: " + INVALID_SIGNATURE_POLICY + "; Available abstractPolicies: [" + VALID_SIGNATURE_POLICY_3 + ", " + VALID_SIGNATURE_POLICY_4 + ", " + VALID_SIGNATURE_POLICY_5 + "]"));
    ...
    public void pdfValidationRequestWrongFilename() {
        ...
        post(validationRequestWithValidKeys(encodedString, "TotallyRandomFilename.exe", ""))
                .then()
                .body("validationReport.validationConclusion.validatedDocument.filename",equalTo("TotallyRandomFilename.exe"))
                .body("validationReport.validationConclusion.validSignaturesCount",Matchers.is(1));
    }
    ...
    public void ddocValidationRequestNotMatchingDocumentTypeAndActualFilePdf() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("PdfValidSingleSignature.pdf"));
        post(validationRequestWithValidKeys(encodedString, "PdfValidSingleSignature.ddoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void ddocValidationRequestWrongSignaturePolicy() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("igasugust1.3.ddoc"));
        post(validationRequestWithValidKeys(encodedString, "igasugust1.3.ddoc", INVALID_SIGNATURE_POLICY))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
    ...
    public void ddocValidationRequestNotMatchingDocumentTypeAndActualFileXroadBatch() {
        setTestFilesDirectory("xroad/");
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("xroad-batchsignature.asice"));
        post(validationRequestWithValidKeys(encodedString, "xroad-batchsignature.ddoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void ddocValidationRequestNotMatchingDocumentTypeAndActualFileXroadAttach() {
        setTestFilesDirectory("xroad/");
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("xroad-attachment.asice"));
        post(validationRequestWithValidKeys(encodedString, "xroad-attachment.ddoc", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void xroadValidationRequestNotMatchingDocumentTypeAndActualFilePdf() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("PdfValidSingleSignature.pdf"));
        post(validationRequestWithDocumentTypeValidKeys(encodedString, "PdfValidSingleSignature.pdf", "xroad", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void xroadValidationRequestNotMatchingDocumentTypeAndActualFileBdoc() {
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("Valid_IDCard_MobID_signatures.bdoc"));
        post(validationRequestWithDocumentTypeValidKeys(encodedString, "Valid_IDCard_MobID_signatures.bdoc", "xroad", ""))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is(DOCUMENT))
                .body("requestErrors[0].message", Matchers.containsString(DOCUMENT_MALFORMED_OR_NOT_MATCHING_DOCUMENT_TYPE));
    ...
    public void xroadValidationRequestWrongSignaturePolicy() {
        setTestFilesDirectory("xroad/");
        String encodedString = Base64.encodeBase64String(readFileFromTestResources("xroad-simple.asice"));
        post(validationRequestWithDocumentTypeValidKeys(encodedString, "xroad-simple.asice", "XROAD", INVALID_SIGNATURE_POLICY))
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("requestErrors[0].key", Matchers.is("signaturePolicy"))
