...
class GenericValidationServiceTLevelTest extends GenericValidationServiceTestBase {

    @Test
    void validateDocument_WhenSignatureLevelIsT_FreshOcspIsTaken() {
        TestLog testLog = new TestLog(LoggingOSCPSourceWrapper.class);
        ValidationDocument validationDocument = buildValidationDocument("asiceWithXades-t-level.asice");
        ...
        assertThat(validationConclusion.getSignatureForm(), equalTo("ASiC-E"));
