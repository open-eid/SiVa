...
/**
 * This class is the customized version of {@link eu.europa.esig.dss.validation.process.BasicValidation}
 */
public class EstonianBasicValidation {
    ...
    private void isInitialised(final XmlNode mainNode, final ProcessParameters params) {
        ...
        if (basicBuildingBlocksReport == null) {
             ...
             */
            final EstonianBasicBuildingBlocks basicBuildingBlocks = new EstonianBasicBuildingBlocks();
