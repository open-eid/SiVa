/*
 * Copyright 2023 - 2026 Riigi Infosüsteemi Amet
 *
...
class AllowedCountriesFilterTest {
    ...
    void filter_WhenCountryIsStringOrNull_ThenReturnBoolean(String country, boolean expectedResult) {
        ...
        CountryFilter countryFilter = new AllowedCountriesFilter(countries);
    ...
    private static Stream<Arguments> argumentSource() {
        return Stream.of(
                ...
                Arguments.of("LT", true),
                Arguments.of("", true),
                Arguments.of(" ", true),
                Arguments.of(".!/@*", true),
                Arguments.of("BE", false),
