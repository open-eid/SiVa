...
public class ValidationReportValueVerificationIT extends SiVaRestTests {
    ...
    public void bdocCorrectValuesArePresentValidLtTmSignature() {
        post(validationRequestFor("Valid_ID_sig.bdoc"))
                ...
                .body("validationConclusion.signatures[0].signedBy", Matchers.is("NURM,AARE,38211015222"))
                ...
                .body("validationConclusion.signatures[0].signatureScopes[0].name", Matchers.is("Proov.txt"))
                ...
                .body("validationConclusion.signatures[0].claimedSigningTime", Matchers.is("2016-05-12T10:09:09Z"))
    ...
    public void bdocCorrectValuesArePresentValidLtSignature() {
        ...
        post(validationRequestFor("23635_bdoc_ts_OCSP_random_nonce.bdoc"))
                ...
                .body("validationConclusion.signatures[0].indication", Matchers.is("TOTAL-PASSED"))
                .body("validationConclusion.signatures[0].errors", Matchers.isEmptyOrNullString())
                .body("validationConclusion.signatures[0].signatureScopes[0].name", Matchers.is("Makefile"))
                .body("validationConclusion.signatures[0].signatureScopes[0].scope", Matchers.is("FullSignatureScope"))
                .body("validationConclusion.signatures[0].signatureScopes[0].content", Matchers.is("Full document"))
                .body("validationConclusion.signatures[0].claimedSigningTime", Matchers.is("2015-11-20T08:32:39Z"))
                .body("validationConclusion.signatures[0].warnings", Matchers.isEmptyOrNullString())
    ...
    public void bdocAllElementsArePresentValidMultipleSignatures() {
        ...
        post(validationRequestWithValidKeys(encodedString, "Baltic MoU digital signing_EST_LT_LV.bdoc", VALID_SIGNATURE_POLICY_3))
                ...
                .body("validationConclusion.signatures[0].signatureFormat", Matchers.is("XAdES_BASELINE_LT_TM"))
                .body("validationConclusion.signatures[0].signatureLevel", Matchers.is("QESIG"))
                .body("validationConclusion.signatures[0].signedBy", Matchers.is("MICHAL,KRISTEN,37507120348"))
                .body("validationConclusion.signatures[0].indication", Matchers.is("TOTAL-PASSED"))
                .body("validationConclusion.signatures[0].errors", Matchers.isEmptyOrNullString())
                .body("validationConclusion.signatures[0].signatureScopes[0].name", Matchers.is("Baltic MoU digital signing_04112015.docx"))
                .body("validationConclusion.signatures[0].signatureScopes[0].scope", Matchers.is("FullSignatureScope"))
                .body("validationConclusion.signatures[0].signatureScopes[0].content", Matchers.is("Full document"))
                .body("validationConclusion.signatures[0].claimedSigningTime", Matchers.is("2015-11-04T10:24:11Z"))
                .body("validationConclusion.signatures[0].warnings", Matchers.isEmptyOrNullString())
    ...
    public void pdfAllElementsArePresentValidSignature() {
        ...
        post(validationRequestFor("hellopades-lt-sha256-ec256.pdf"))
                .then()
                .body(matchesJsonSchemaInClasspath("SimpleReportSchema.json"))
                .body("validationConclusion.signatures[0].id", Matchers.is("id-85aeeca3c7135efa1c42b69dfcba898c780e552845d04b66868301a5cf0ed8ba"))
                .body("validationConclusion.signatures[0].signatureFormat", Matchers.is("PAdES-BASELINE-LT"))
                .body("validationConclusion.signatures[0].signatureLevel", Matchers.is("QESIG"))
                .body("validationConclusion.signatures[0].signedBy", Matchers.is("Veiko Sinivee"))
                .body("validationConclusion.signatures[0].indication", Matchers.is("TOTAL-PASSED"))
                .body("validationConclusion.signatures[0].errors", Matchers.isEmptyOrNullString())
                .body("validationConclusion.signatures[0].signatureScopes[0].name", Matchers.is("PDF previous version #1"))
                .body("validationConclusion.signatures[0].signatureScopes[0].scope", Matchers.is("PdfByteRangeSignatureScope"))
                .body("validationConclusion.signatures[0].signatureScopes[0].content", Matchers.is("The document byte range: [0, 14153, 52047, 491]"))
                .body("validationConclusion.signatures[0].claimedSigningTime", Matchers.is("2015-08-25T10:15:06Z"))
                .body("validationConclusion.signatures[0].warnings", Matchers.isEmptyOrNullString())
    ...
    public void pdfAllElementsArePresentValidmultipleSignatures() {
        ...
        post(validationRequestFor("pades_lt_two_valid_sig.pdf"))
                .then()
                .body(matchesJsonSchemaInClasspath("SimpleReportSchema.json"))
                .body("validationConclusion.signatures[1].id", Matchers.is("id-4a63aba993298157bf1df8d29e14241654991a12c73036390788f2a46af27865"))
                .body("validationConclusion.signatures[1].signatureFormat", Matchers.is("PAdES-BASELINE-LT"))
                .body("validationConclusion.signatures[1].signatureLevel", Matchers.is("QESIG"))
                .body("validationConclusion.signatures[1].signedBy", Matchers.is("VOLL,ANDRES,39004170346"))
                .body("validationConclusion.signatures[1].indication", Matchers.is("TOTAL-PASSED"))
                .body("validationConclusion.signatures[1].errors", Matchers.isEmptyOrNullString())
                .body("validationConclusion.signatures[1].signatureScopes[0].name", Matchers.is("Full PDF"))
                .body("validationConclusion.signatures[1].signatureScopes[0].scope", Matchers.is("FullSignatureScope"))
                .body("validationConclusion.signatures[1].signatureScopes[0].content", Matchers.is("Full document"))
                .body("validationConclusion.signatures[1].claimedSigningTime", Matchers.is("2016-06-27T09:59:37Z"))
