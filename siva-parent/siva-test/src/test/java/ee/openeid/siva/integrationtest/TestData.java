...
public class TestData {
    ...
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_PADES_B = "PAdES-BASELINE-B";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_XADES_B = "XAdES-BASELINE-B";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_XADES_LT_TM = "XAdES-BASELINE-LT-TM";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_XADES_LT = "XAdES_BASELINE_LT";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_XADES_B_BES = "XAdES-BASELINE-B-BES";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_SK_XML = "SK_XML_1.0";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_DIGIDOC_XML = "DIGIDOC_XML_1.3";
    public static final String VALID_VALIDATION_CONCLUSION_SIGNATURE_FORMAT_BDOC_TM = "BDOC_2.1";
