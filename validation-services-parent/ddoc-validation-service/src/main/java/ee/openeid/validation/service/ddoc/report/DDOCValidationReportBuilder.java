...
public class DDOCValidationReportBuilder {
    ...
    public DDOCValidationReportBuilder(SignedDoc signedDoc, ValidationDocument validationDocument, ValidationPolicy validationPolicy, boolean isReportSignatureEnabled) {
